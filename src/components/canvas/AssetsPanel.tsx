          ...
          <div className="flex flex-col gap-1">
            {filteredCodes.map((code) => (
              <div
                ...
                className="flex cursor-grab items-center gap-2 rounded-md p-2 hover:bg-[var(--surface-hover)] transition-colors active:cursor-grabbing group"
              >
                <Hash className="h-3.5 w-3.5" style={{ color: code.color }} />
          ...
          <div className="flex flex-col gap-2">
            {filteredQuotes.map((quote) => (
              <div
                ...
                className="flex cursor-grab flex-col gap-1 rounded-md border border-[var(--border-subtle)] bg-[var(--bg-primary)] p-2 hover:border-[var(--border)] transition-all active:cursor-grabbing group"
              >
                <div className="flex items-center gap-1 opacity-60">
                  <Quote className="h-3 w-3 text-[var(--accent)]" />
                  <span className="text-[9px] font-bold uppercase truncate">{quote.docName}</span>
                </div>
