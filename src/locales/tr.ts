export const tr = {
    ...
    "welcome.hint": "Komut paleti için Cmd+K veya Ctrl+K tuşlarını kullanın",
    "welcome.startReading": "Okumaya Başla",
    "welcome.selectDoc": "Sol panelden bir belge seçin veya yeni bir dosya yükleyin.",
    ...
    "analysis.export.goAnalysis": "Grafik dışa aktarmak için Analiz sekmesine gidin.",
